...
import static com.gmail.herman.uladzimir.command.ResponsePath.FORWARD_TO_USER_NEWS_PAGE;

public class UserNewsViewCommand implements Command {

    private static final Logger LOGGER = LogManager.getLogger(UserNewsViewCommand.class);
