...
import static com.gmail.herman.uladzimir.route.ResponsePath.FORWARD_TO_ADMIN_ORDERS_OPEN_PAGE;

/**
 * This class is used to get the open orders page.
 *
...
public class AdminOrdersOpenViewCommand implements Command {
    ...
    private static final Logger LOGGER =
            LogManager.getLogger(AdminOrdersOpenViewCommand.class);
        ...
        try {
            ...
            if (paginationValidator.isPageNumberCorrect(page)) {
                ...
                int pageQuantity = PaginationUtil.definePageQuantity
                        (orderService.countOpen(), ITEMS_ON_THE_PAGE);
